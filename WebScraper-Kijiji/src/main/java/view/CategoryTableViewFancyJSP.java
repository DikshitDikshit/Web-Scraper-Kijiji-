 ...
 */
@WebServlet(name = "CategoryTableFancyJSP", urlPatterns = {"/CategoryTableFancyJSP"})
public class CategoryTableViewFancyJSP extends HttpServlet {
     ...
     private void fillTableData(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/jsp/ShowTable-Category.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        log("POST");
        //get the path of request, for example this page will likely be /CategoryTableViewFancyJSP
        //String path = req.getServletPath();
    ...
    public String getServletInfo() {
        return "Smaple of Category Table using JSP";
    }
