 ...
 */
@WebServlet(name = "ItemTableViewFancyJSP", urlPatterns = {"/ItemTableViewFancyJSP"})
public class ItemTableViewFancyJSP extends HttpServlet {
   ...
   private void fillTableData(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/jsp/ShowTable-Item.jsp").forward(req, resp);
    }
    ...
    public String getServletInfo() {
        return "Sample of Image Table using JSP";
    }
